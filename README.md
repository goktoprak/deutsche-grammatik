...
site.js             gemeinsames Seitengerüst: Kopf- und Fußzeile,
...
3. das Thema in die Liste `THEMEN` in `site.js` eintragen – dann erscheint es automatisch beim Blättern (vorheriges/nächstes Thema).
